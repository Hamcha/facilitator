...
#error unsupport ABI
...
#endif
	{
		...
		switch (call.realMap) {
			...
			case 1:
				((void(AUTO_RPC_CALLSPEC*)(HardwareReal, NaturalWord, NaturalWord, NaturalWord, AUTO_RPC_NW_4_64))functionPtr)(
			...
			case 3:
				...
				break;
			case 4:
				((void(AUTO_RPC_CALLSPEC*)(NaturalWord, NaturalWord, HardwareReal, NaturalWord, AUTO_RPC_NW_4_64))functionPtr)(
			...
			case 7:
				...
				break;
			case 8:
				((void(AUTO_RPC_CALLSPEC*)(NaturalWord, NaturalWord, NaturalWord, HardwareReal, AUTO_RPC_NW_4_64))functionPtr)(
			...
			case 11:
				...
				break;
			case 12:
				((void(AUTO_RPC_CALLSPEC*)(NaturalWord, NaturalWord, HardwareReal, HardwareReal, AUTO_RPC_NW_4_64))functionPtr)(
